...
if __name__ == "__main__":
    ...
    # seg_model_path = 'runs/segment/train5/weights/FP16_openvino_model/v8_seg_FP16.xml'
    # seg_model_path = 'runs/segment/train5/weights/FP32_openvino_model/v8_seg_FP32.xml'
    seg_model_path = 'runs/segment/train5/weights/Int8_openvino_model/v8_seg_Int8.xml'
    core = Core()
    ...
    SEG_MODEL = YOLO(f'runs/segment/train2/weights/best.pt')
    label_map = SEG_MODEL.model.names

    image_folder = 'datasets/coco128-seg/images/train2017\*.jpg'
